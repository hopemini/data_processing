...
plt.savefig('../result/' + args.dir + '_nmi_means.png', transparent=True)
...
plt.xlabel(r'$\beta$')
plt.legend(loc='lower right')
plt.savefig('../result/' + args.dir + '_ari_means.png', transparent=True)
...
plt.xlabel(r'$\beta$')
plt.legend(loc='lower right')
plt.savefig('../result/' + args.dir + '_purity_means.png', transparent=True)

df_ari.to_csv('../result/' + args.dir + '_ari_means.csv')
df_nmi.to_csv('../result/' + args.dir + '_nmi_means.csv')
df_purity.to_csv('../result/' + args.dir + '_purity_means.csv')
